...
export const DEFAULT_X_SOURCE_ID = stableUuid("rasd:default:source:x");
export const DEFAULT_NEWS_SOURCE_ID = stableUuid("rasd:default:source:news");
export const DEFAULT_AAWSAT_GULF_SOURCE_ID = stableUuid("rasd:default:source:aawsat-gulf");
export const DEFAULT_AAWSAT_EDUCATION_SOURCE_ID = stableUuid("rasd:default:source:aawsat-education");
export const DEFAULT_X_SEARCH_SOURCE_ID = stableUuid("rasd:default:source:x-search");
