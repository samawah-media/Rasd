...
export default function DirectoryClient() {
  ...
  const cameraCards = [
    ...
    },
    {
      ...
      description: "متابعة المواد الواردة حياً وتدقيق التغريدات والأخبار ومراجعة صحة تصنيف الذكاء الاصطناعي والمشاعر.",
    ...
    },
    {
      ...
      description: "استعراض التقرير الموجه لرئاسة الحرمين الشريفين، إحصائيات المشاعر، خريطة الأيام التفاعلية وتوليد PDF المعتمد.",
