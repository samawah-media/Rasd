...
- صفحة `/client-report` تعرض نفس الـ 124 مادة كتقرير عميل تفاعلي حديث: يمكن اختيار يوم محدد أو range، فلترة المنصة/الإصدار/الثقة/المشاعر، رؤية صورة الدليل، وفتح الرابط الأصلي المستخرج من أيقونة PDF.
